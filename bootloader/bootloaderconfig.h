...
/* Example configuration: Port D bit 5 is connected to a jumper which ties
...
static inline void  bootLoaderExit(void)
{
    ...
    PORTC = 0;
    eepromWrite(UBOOT_SOFTJUMPER_ADDRESS, 0x00);
}

#define bootLoaderCondition()   ((!(PIND & (1 << JUMPER_BIT)))||eepromRead(UBOOT_SOFTJUMPER_ADDRESS, UBOOT_SOFTJUMPER))
